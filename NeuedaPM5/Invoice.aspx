                                ...
                                <div class="col-lg-12">
                                    <form role="form" runat="server">
                                        <div class="form-group">
                                            <label>Invoicing Instructions</label>
                                            <asp:TextBox ID="txtInvoiceInstructions" CssClass="form-control" Rows="4" runat="server" TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                        <asp:Button class="btn btn-primary" id="btnSubmit" text="Submit" runat="server" OnClick="btnSubmit_OnClick"></asp:Button>
                                        <asp:Button class="btn btn-default" id="btnReset" text="Reset" runat="server" OnClick="btnReset_OnClick"></asp:Button>
                                    </form>
                                <br />
                                <div class="row">
                <div class="col-lg-12">
